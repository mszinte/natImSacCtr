...
const.img_contrast_num      =   2;                                                                  % number of image contrast
const.img_size_num          =   2;                                                                  % number of image size
const.trials_tot_num        =   (const.img_tot_num * const.img_contrast_num * const.img_size_num);  % total number of trials
